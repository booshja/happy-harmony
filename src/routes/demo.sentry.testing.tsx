...
function RouteComponent() {
    ...
    const [_replayEvents, setReplayEvents] = useState<Array<string>>([]);
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-4xl font-semibold text-white">
                            Code <span className="inline-block -rotate-9">breaks</span>,
                            fix it faster
                        </p>
                    </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-[#1C2333] rounded-lg border border-gray-800 p-6">
                            <div className="space-y-4 text-gray-300">
                                <p>
                                    The Sentry integration monitors this application
                                    across all routes; not just this one (we care about
                                    all tabs) using our <code>@sentry/react</code> and{" "}
                                    <code>@sentry/node</code> packages.
                                </p>
                                            ...
                                            <div className="mt-4 space-y-2">
                                                <div className="bg-red-900/20 border border-red-500/50 rounded-lg p-2">
                                                    <div className="flex items-center text-red-400 text-sm">
                                                        ...
                                                        Client-side error captured and
                                                        traced
                                                    </div>
                                                </div>
                                            ...
                                            <div className="mt-4 space-y-2">
                                                <div className="bg-red-900/20 border border-red-500/50 rounded-lg p-3">
                                                    <div className="flex items-center text-red-400 text-sm">
                                                        ...
                                                        Server-side error captured and
                                                        traced
                                                    </div>
                                                </div>
                                                <div className="bg-purple-900/20 border border-purple-500/50 rounded-lg p-3">
